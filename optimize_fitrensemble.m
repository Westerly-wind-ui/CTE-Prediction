function [Mdl,fMin,Convergence_curve]  = optimize_fitrensemble(train_x_feature_label_norm,train_y_feature_label_norm,vaild_x_feature_label_norm,vaild_y_feature_label_norm,num_pop,num_iter,method_mti)
...
UB=[150,0.7];
nvars=length(LB);
fit_fitrensemble1=@fit_fitrensemble;
...
elseif strcmp( method_mti,'GDPSO黄金正余弦改进PSO')==1
  ...
  disp([method_mti, '优化 fitrensemble:   ',"NumLearningCycles:",num2str(round(pos(1))),'   LearnRate: ',num2str(pos(2))]) 
     figure
...
function [fitness_value,Mdl]=fit_fitrensemble(pop,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
%    global train_x_feature_label_norm train_y_feature_label_norm vaild_x_feature_label_norm vaild_y_feature_label_norm
    Mdl= fitrensemble(train_x_feature_label_norm,train_y_feature_label_norm,"NumLearningCycles",pop(1),"LearnRate",pop(2));  
...
%%
%  [fMin,Mdl_best,Convergence_curve]=DBO_DBO(pop,M,c,d,dim,fobj,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)       
...
function result = yinshe( N, dim,label)
if label==1
        % tent 映射
        tent=1.2;  %tent混沌系数
        Tent=rand(N,dim);
