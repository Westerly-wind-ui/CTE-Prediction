function [Mdl,fMin,Convergence_curve]  = optimize_fitrtrsvm(train_x_feature_label_norm,train_y_feature_label_norm,vaild_x_feature_label_norm,vaild_y_feature_label_norm,num_pop,num_iter,method_mti)  
...
%  Mdl= fitrensemble(train_x_feature_label_norm,train_y_feature_label_norm,"NumLearningCycles",50,"LearnRate",1);  
     ...
     UB=[5,30,1];
     nvars=length(LB);
     fit_fitrensemble1=@fit_fitrtrsvm;
...
function [fitness_value,Mdl]=fit_fitrtrsvm(pop,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
%    global train_x_feature_label_norm train_y_feature_label_norm vaild_x_feature_label_norm vaild_y_feature_label_norm
    Mdl= fitrsvm(train_x_feature_label_norm,train_y_feature_label_norm,'KernelFunction','linear','KernelScale',pop(1),'BoxConstraint',pop(2),'Epsilon',pop(3));  
