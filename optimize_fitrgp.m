function [Mdl,fMin,Convergence_curve]  = optimize_fitrgp(train_x_feature_label_norm,train_y_feature_label_norm,vaild_x_feature_label_norm,vaild_y_feature_label_norm,num_pop,num_iter,method_mti)  
...
%  Mdl= fitrensemble(train_x_feature_label_norm,train_y_feature_label_norm,"NumLearningCycles",50,"LearnRate",1);  
     ...
     UB=[10,10,0.8];
     nvars=length(LB);
     fit_fitrensemble1=@fit_fitrkernel;
...
%   disp([method_mti, '优化 fitrsvm:   ',"KernelScale:",num2str((pos(1))),'   BoxConstraint: ',num2str(pos(2)),'   Epsilon: ',num2str(pos(3))]) 
 disp([method_mti, '优化 fitrgp:   ',"KernelParameters:",num2str([(pos(1)),pos(2)]),'   Sigma: ',num2str(pos(3))]) 
     figure
...
function [fitness_value,Mdl]=fit_fitrkernel(pop,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
%    global train_x_feature_label_norm train_y_feature_label_norm vaild_x_feature_label_norm vaild_y_feature_label_norm
    Mdl= fitrgp(train_x_feature_label_norm,train_y_feature_label_norm,'KernelFunction','squaredexponential','KernelParameters',[pop(1),pop(2)],'Sigma',pop(3));  
