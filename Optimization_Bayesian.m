...
for select_feature_num = 1:12
    ...
    %     [Mdl, ~] = train(Mdl, train_x_feature_label_norm', train_y_feature_label_norm');  % 训练网络
    %     y_train_predict_norm = sim(Mdl, train_x_feature_label_norm');
    %     y_train_predict_norm = y_train_predict_norm';
    %     y_vaild_predict_norm = sim(Mdl, vaild_x_feature_label_norm');
    %     y_vaild_predict_norm = y_vaild_predict_norm';
    ...
    %         y_test_predict_norm_all_testk=sim(Mdlkf,x_feature_label_norm_all_testk'); y_test_predict_norm_all_testk=y_test_predict_norm_all_testk'; %测试集预测结果
...
%        [Mdlkf] = newff(x_feature_label_norm_all_traink',y_feature_label_norm_all_traink',hidden_size,{'logsig','tansig','purelin'});
       Mdl = fitnet(hidden_size, 'trainadam'); 
