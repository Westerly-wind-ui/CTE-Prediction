function [Mdl,fMin,Convergence_curve]  = optimize_fitrtreebag1(train_x_feature_label_norm,train_y_feature_label_norm,vaild_x_feature_label_norm,vaild_y_feature_label_norm,num_pop,num_iter,method_mti)
...
UB=[200,5];
nvars=length(LB);
fit_fitrensemble1=@fit_fitrtreebag;
...
elseif strcmp( method_mti,'GDPSO黄金正余弦改进PSO')==1
   ...
   box off 
 disp([method_mti, '优化 TreeBagger:   ',"tree_num:",num2str(round(pos(1))),'   MinLeafSize: ',num2str(round(pos(2)))]) 
end
function [fitness_value,Mdl]=fit_fitrtreebag(pop,train_x_feature_label_norm, train_y_feature_label_norm, vaild_x_feature_label_norm, vaild_y_feature_label_norm)
%    global train_x_feature_label_norm train_y_feature_label_norm vaild_x_feature_label_norm vaild_y_feature_label_norm
    Mdl=TreeBagger(round(pop(1)),train_x_feature_label_norm,train_y_feature_label_norm,'Method','regression','MinLeafSize',round(pop(2)));  
