...
if __name__ == '__main__':
    # 包含训练集、验证集和测试集
    y_train = np.load(r"train_y_feature_label_py_CTE.npy")
    y_pred_train = np.load(r"y_train_pred_all_py_CTE.npy")
    y_test = np.load(r"test_y_feature_label_py_CTE.npy")
    y_pred_test = np.load(r"y_test_pred_all_py_CTE.npy")
    y_val = np.load(r"vaild_y_feature_label_py_CTE.npy")
    y_pred_val = np.load(r"y_vaild_pred_all_py_CTE.npy")
